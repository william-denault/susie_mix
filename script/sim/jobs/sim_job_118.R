...
if (file.exists("/project2/mstephens/wdenault/susie_mix/simulation results/chunks/additive_recessive_dominant_add2_rec1_dom1_n500_L10_pve0.2_seed1e+06_reps200_chunk1.RData")) {
  load("/project2/mstephens/wdenault/susie_mix/simulation results/chunks/additive_recessive_dominant_add2_rec1_dom1_n500_L10_pve0.2_seed1e+06_reps200_chunk1.RData")
} else {
  results <- list()
}
...
if (start <= 200) for (o in start:200) {
  ...
  results[[o]] <- temp
  save(results, file = "/project2/mstephens/wdenault/susie_mix/simulation results/chunks/additive_recessive_dominant_add2_rec1_dom1_n500_L10_pve0.2_seed1e+06_reps200_chunk1.RData.tmp")
