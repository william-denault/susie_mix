...
$taskStage = (Resolve-Path -LiteralPath 'C:/Document/Serieux/Travail/Data_analysis_and_papers/susie_mix/tmp/manuscript_em_active_update').Path
...
$taskFiles = @('susie_mix_manuscript.tex')
$taskChanges = @()
